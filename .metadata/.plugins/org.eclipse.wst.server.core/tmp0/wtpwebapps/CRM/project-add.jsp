            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" action="<%=request.getContextPath() + Common.PROJECT_CREATE %>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="date" name="end_date" required="required" class="form-control form-control-line"> 
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <a href="<%=request.getContextPath() + Common.PROJECT%>" class="btn btn-primary">Back</a>
                                    </div>
                                </div>
                            </form>
                        </div>
