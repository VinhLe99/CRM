...
<body>
                            ...
                            <div class="user-bg"> <img width="100%" alt="user" src="assets/plugins/images/large/img1.jpg">
                                <div class="overlay-box">
                                    <div class="user-content">
	                                        <a href="javascript:void(0)"><img src="assets/plugins/images/users/genu.jpg"
	                                                class="thumb-lg img-circle" alt="img"></a>
	                                         
	                                        <h4 class="text-white"><c:out value="${user.fullname}"></c:out></h4>
	                                        <h5 class="text-white">info.<c:out value="${user.email}"></c:out></h5>
                                    </div>
                                </div>
                            </div>
	...
	<!-- END THỐNG KÊ -->
                ...
                <c:forEach items="${listtask}" var="item">
                    <div class="col-md-4">
                        <div class="white-box">                        
                            <h3 style="text-align: center;">${item.task_name}</h3>
                            <div class="message-center">
                                <div class="mail-contnet">
                                	<label>Start date:</label>  
	                                <span class="time" style="font-size: 14px">${item.start_date}</span>
	                                <label>End date:</label> 
	                                <span class="time" style="font-size: 14px">${item.end_date}</span>
	                                <label>Status:</label>                                       
	                                <c:choose>
										<c:when test="${item.status == 1}">
											<small class="badge badge-pill badge-success">Finished</small>
										</c:when>
										<c:otherwise>
											<small class="badge badge-pill badge-warning">Unfinished</small>
										</c:otherwise>
									</c:choose>
                                </div>
                            </div>
